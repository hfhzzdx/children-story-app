...
public final class PlayerViewModel extends androidx.lifecycle.ViewModel {
     ...
     * 调整播放速度
     */
    public final void adjustPlaybackSpeed(float newSpeed) {
    }
    
    /**
     * 调整音量
     */
    public final void adjustVolume(float newVolume) {
    }
    ...
    java.util.List<com.dunzi.storyhouse.data.model.Story> stories) {
    }
