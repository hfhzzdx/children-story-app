    ...
    fun generateMockStories(): List<Story> {
        return listOf(
            Story(
                ...
                contentPath = "从前有三只小猪，它们决定各自建造一座房子...",
                category = "通话故事",
                ...
                audioPath = "https://example.com/three-pigs.mp3",
                isFavorite = true,
                playCount = 15,
                lastPlayedAt = Date(),
                progress = 0.8f,
            ...
            Story(
                ...
                contentPath = "从前有个可爱的小姑娘，大家都叫她小红帽...",
                category = "通话故事",
                ...
                audioPath = "https://example.com/red-riding-hood.mp3",
                isFavorite = false,
                playCount = 8,
                lastPlayedAt = Date(),
                progress = 0.3f,
            ...
            Story(
                ...
                audioPath = "https://example.com/tortoise-hare.mp3",
                isFavorite = true,
                playCount = 12,
                lastPlayedAt = Date(),
                progress = 1.0f,
            ...
            Story(
                ...
                contentPath = "在绿色的大房间里，有一只小兔子躺在床上...",
                category = "睡前故事",
                ...
                audioPath = "https://example.com/goodnight-moon.mp3",
                isFavorite = false,
                playCount = 25,
                lastPlayedAt = Date(),
                progress = 0.5f,
            ...
            Story(
                ...
                contentPath = "老爷爷种了一棵萝卜，萝卜长得又大又结实...",
                category = "通话故事",
                ...
                audioPath = "https://example.com/turnip.mp3",
                isFavorite = true,
                playCount = 18,
                lastPlayedAt = Date(),
                progress = 0.9f,
            ...
            Story(
                ...
                audioPath = "https://example.com/little-horse.mp3",
                isFavorite = false,
                playCount = 6,
                lastPlayedAt = Date(),
                progress = 0.2f,
            ...
            Story(
                ...
                contentPath = "很久很久以前，地球上生活着各种各样的恐龙...",
                category = "科普故事",
                ...
                audioPath = "https://example.com/dinosaurs.mp3",
                isFavorite = true,
                playCount = 9,
                lastPlayedAt = Date(),
                progress = 0.4f,
            ...
            Story(
                ...
                audioPath = "https://example.com/wait-rabbit.mp3",
                isFavorite = false,
                playCount = 4,
                lastPlayedAt = Date(),
                progress = 0.1f,
            ...
            Story(
                ...
                contentPath = "从前有一只小鸭子，它长得和其他小鸭子不一样...",
                category = "通话故事",
                ...
                audioPath = "https://example.com/ugly-duckling.mp3",
                isFavorite = true,
                playCount = 11,
                lastPlayedAt = Date(),
                progress = 0.7f,
            ...
            Story(
                ...
                audioPath = "https://example.com/star-travel.mp3",
                isFavorite = false,
                playCount = 7,
                lastPlayedAt = Date(),
                progress = 0.6f,
